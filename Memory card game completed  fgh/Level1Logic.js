...
//             }).then(() => {
            ...
            setTimeout(() => {
                if (window.confirm("Congratulations!!! You have completed this level. Click OK to play the Tomato Game")) {
                    window.location.href = `Tomato.html?level=${level}&timeLeft=${timeLeft}`;
                }
            }, 1000);
        // });
